...
class ItemController extends Controller
{
    ...
    $cacheKey = "popular_products_{$zone_id}_{$type}_{$limit}_{$offset}";
  ...
  // Validate zoneId header
    ...
    $cacheKey = "most_reviewed_products_{$zone_id}_{$limit}_{$offset}_{$type}";

    // Cache the query result for 5 min
