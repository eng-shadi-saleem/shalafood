...
<style>
 #pac-input {
        width: 400px; /* Adjust width to make the input field larger */
        height: 50px; /* Adjust height to make the input field taller */
        font-size: 16px; /* Optional: Change font size if you want larger text */
        padding: 10px; /* Optional: Adjust padding for a bigger input feel */
    }

    /* Optionally, adjust the container around the input */
    ...
    <input type="email" id="email" name="email" class="form-control" placeholder="{{ translate('messages.Ex:') }} ex@example.com"
    value="{{old('email')}}">
</div>
                                </div>
                                <div class="col-md-4 col-12">
