                                        ...
                                        <div class="d-flex flex-wrap flex-md-row-reverse" style="gap:15px">
                                            ...
                                            @php($item = is_array($item)?$item:['img'=>$item,'storage'=>'public'])
                                                ...
                                                @else
                                                    ...
                                                    <button type="button" class="btn w-100 px-0" data-toggle="modal" data-target="#imagemodal{{ $key }}">
                                                        Open Video
                                                    </button>

                                                    <!-- Modal Structure -->
                                                    <div class="modal fade" id="imagemodal{{ $key }}" tabindex="-1" role="dialog" aria-labelledby="myModalLabel{{ $key }}" aria-hidden="true">
                                                            ...
                                                            <div class="modal-content">
                                                                <div class="modal-header">
                                                                    ...
                                                                    <button type="button" class="close" data-dismiss="modal">
                                                                        ...
                                                                        <span class="sr-only">{{ translate('messages.cancel') }}</span>
                                                                    </button>
                                                                </div>
                                                                <div class="modal-body">
                                                                    <video id="video-{{ $key }}" width=100% height=100% controls>
                                                    ...
                                                    <script>
                                                        $(document).ready(function() {
                                                            $('#imagemodal{{ $key }}').on('show.bs.modal', function() {
                                                                const videoSource = "{{ isset($item['vid']) ? asset('storage/app/public/order/' . $item['vid']) : '' }}";
                                                                if (videoSource) {
                                                                    $('#video-{{ $key }} source').attr('src', videoSource);
                                                                    $('#video-{{ $key }}')[0].load();
                                                                }
                                                            });
                                                            // Clear video source when modal is hidden
                                                            $('#imagemodal{{ $key }}').on('hidden.bs.modal', function() {
                                                                $('#video-{{ $key }} source').attr('src', '');
                                                            });
                                                        });
                                                    </script>
                                                @endif
...
@push('script_2')
    ...
    <!-- JavaScript to load video on modal show -->
